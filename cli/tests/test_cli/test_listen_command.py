...
from layerbrain_cli.commands.listen import _build_signature_header, _merge_forward_url
...
class TestListenCommand(unittest.TestCase):
    @patch("layerbrain_cli.commands.listen.asyncio.run")
    @patch("layerbrain_cli.commands.listen._run_listen", new_callable=AsyncMock)
    @patch("layerbrain_cli.commands.listen.Layerbrain")
    ...
    @patch("layerbrain_cli.commands.listen._generate_forward_secret", return_value="whsec_fixed")
    @patch("layerbrain_cli.commands.listen.asyncio.run")
    @patch("layerbrain_cli.commands.listen._run_listen", new_callable=AsyncMock)
    @patch("layerbrain_cli.commands.listen.Layerbrain")
